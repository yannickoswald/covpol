    ...
    def compute_distance(self):
       ...
       '''
        ...
        DESCRIPTION
         ...
         lockdown. Then the agent sorts these distances and take the average
...
class CountryModel(mesa.Model):
    ...
    def __init__(self, base_alert, social_base_threshold, 
        ...
        for i in range(self.num_agents):
            ...
            z = base_alert
            a.alert_adoption_threshold = (x**2) * (1/y) * z
            ...
            a.social_adoption_threshold = x1 * y1
...
for i in range(No_of_particles):
        ### call the model iteration
        ##4th parameter initial conditions can be real, no countries yet or random
        current_model = copy.deepcopy(CountryModel(0.01, 0.13, 18, 'real', 'no', i))
