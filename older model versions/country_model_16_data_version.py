...
def advance_particle(particles):    
...
for i in range(len(list_of_particles)):
        ...
        list_of_errors.append(error_particle_obs(list_of_particles))
...
def resample_particles(list_of_particles_arg):

    number_of_particles = len(list_of_particles_arg)
    ...
    list_of_particles = [list_of_particles[int(x)] for x in re_sampled_particles]
    return list_of_particles
